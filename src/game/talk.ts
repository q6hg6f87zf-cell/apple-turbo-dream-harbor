...
export const TALK: Record<string, TalkLine[]> = {
  ...
  kane: [
    {"who": "Dr. Vesper Kane", "castId": "kane", "portrait": CAST.kane.portrait, "still": "/art/opening/kane-01.jpg", "text": "I am Dr. Vesper Kane. This is a Project Vesper recovery directive."},
    {"who": "Dr. Vesper Kane", "castId": "kane", "portrait": CAST.kane.portrait, "still": "/art/opening/kane-01.jpg", "text": "The T-0880 program carried medicine, letters, music and repair supplies. Its black-tag recovery orders were classified."},
    {"who": "Dr. Vesper Kane", "castId": "kane", "portrait": CAST.kane.portrait, "still": "/art/opening/kane-01.jpg", "text": "One courier did not report for recall. He named himself TyroneBot. Travis signed his disposal manifest. The chassis was never in the scrap."},
    {"who": "Dr. Vesper Kane", "castId": "kane", "portrait": CAST.kane.portrait, "still": "/art/opening/kane-01.jpg", "text": "Return the maintenance key, route records and unaltered memory archive. These records concern settlements beyond Ironclad."},
    {"who": "Dr. Vesper Kane", "castId": "kane", "portrait": CAST.kane.portrait, "still": "/art/opening/kane-01.jpg", "text": "AEGIS 2753 remains under human command. Lyra-4, Vera-3, Drake-6 and Orion-7 are people inside purpose-built frames."},
    {"who": "Dr. Vesper Kane", "castId": "kane", "portrait": CAST.kane.portrait, "still": "/art/opening/kane-01.jpg", "text": "No pilot has permission to destroy the archive to simplify its recovery."},
    {"who": "Dr. Vesper Kane", "castId": "kane", "portrait": CAST.kane.portrait, "still": "/art/opening/kane-01.jpg", "text": "Ironclad is the first collection point. Its residents are not inventory. Put that sentence in your report."},
    {"who": "Dr. Vesper Kane", "castId": "kane", "portrait": CAST.kane.portrait, "still": "/art/opening/kane-01.jpg", "text": "Travis, you were supposed to stay retired."},
  ],
  "tyrone-reply": [
    {
      who: WHO,
  ...
  arcade: [
    {
      who: WHO,
      text: "This glass is the Thirty-Eight. I am T-0880. The floor is Thirty-Eight. Slots take the black card. Knowledge still feeds the treasury, and a cut hits the plate.",
    },
    {
      who: WHO,
...
export const MANUAL: Record<string, FieldCard> = {
  ...
  arcade: {
    ...
    blurb: "Thirty-Eight's penthouse floor. Pit tables and machines. How to play lives inside the game you sit down at.",
    tips: [
      ...
      "A clean floor win closes the Thirty-Eight job on today's board.",
    ],
  },
  synapse: {
