...
export const VILLAINS: VillainDef[] = [
  {
    ...
    lore: "Human convoy commander who escorted T-0880 couriers. He deserted when Vesper reused aid maps to pressure settlements. HOUND-LEAD is the identity Tyrone remembers. Hound’s Tooth is his .50 convoy-defense rifle; the Black-tag Ledger is evidence. A dead owner cannot testify.",
    hp: 32,
    atk: 6,
    def: 5,
    dc: 14,
  ...
  },
  {
    ...
    lore: "Human industrial-disaster survivor. CIVITAS locked the furnace workers inside; Valdris survived but his name remained on the death list. The Furnace Court rules through debt. The Balance is a thermal industrial maul. Tithe Keys control gates, conveyors and coolant.",
    hp: 28,
    atk: 5,
    def: 5,
    dc: 15,
  ...
  },
  {
    ...
    lore: "Surveyor and whistleblower. Thessaly’s original report warned STOP EXTRACTION. Reeve altered the risk assessment; a lift crew died. She protects the Blackglass deepworks. True North is her survey rifle, not a magical map. Cooperation preserves authenticated evidence.",
    hp: 30,
    atk: 5,
    def: 4,
    dc: 15,
  ...
  },
  {
    ...
    lore: "A surviving CIVITAS flood-control shard beneath Brasswater in the Fraser delta. Contradictory protection and evacuation orders became coercive control of the water. Bounded navigation models can help repair Earth; unrestricted autonomy can repeat the original failure.",
    hp: 36,
    atk: 4,
    def: 6,
    dc: 16,
  ...
  },
  {
    ...
    lore: "Captain Mara Thorne is the human pilot of Veyra’s AEGIS 2753 boundary frame. She confirms targets and can recognize lawful authority. Gate Spear grounds powered machinery at close range. Her judgment cannot be recovered from a destroyed suit.",
    hp: 48,
    atk: 8,
    def: 7,
    dc: 18,
...
export const LEDGER_POOLS: Record<"bargain" | "essential" | "artifact", ShopOffer[]> = {
  bargain: [
    ...
    { name: "Field Gel", price: 220, kind: "consumable", rarity: "Common", effect: "Restore 3 HP." },
  ...
  essential: [
    ...
    { name: "Trauma Roll", price: 480, kind: "consumable", rarity: "Uncommon", effect: "Restore 5 HP. Clears bleed." },
  ],
  artifact: [
...
export const WEAPONS:WeaponDef[]=[
 {name:'Vault 13 Work Knife',cls:'Rogue',type:'Piercing',rarity:'Common',damage:'1d4',effect:'Cable, cloth and seals.',lore:'A maintained utility blade.',value:85},
 {name:'Furnace Cleaver',cls:'Warrior',type:'Heavy',rarity:'Uncommon',damage:'1d8',effect:'Close industrial tool.',lore:'Forged from furnace scrap.',value:320},
 {name:'Insulated Line Tool',cls:'Wizard',type:'Blunt',rarity:'Common',damage:'1d4',effect:'Safe maintenance grip.',lore:'A service tool, not a magic focus.',value:90},
 {name:'Medical Shears',cls:'Healer',type:'Piercing',rarity:'Common',damage:'1d4',effect:'Medical utility.',lore:'For bandages before blades.',value:80},
 {name:'Rail Prybar',cls:'Merchant',type:'Blunt',rarity:'Common',damage:'1d6',effect:'Mechanical leverage.',lore:'Opens abandoned freight.',value:100},
 {name:'Route Throwers',cls:'Bard',type:'Thrown',rarity:'Common',damage:'1d4',effect:'Compact throwing tools.',lore:'Balanced courier tools.',value:90},
];

export const ARMOR:{name:string;cls:ClassName;rarity:Rarity;defense:number;effect:string;value:number}[]=[
 {name:'Rivetguard Vest',cls:'Warrior',rarity:'Common',defense:2,effect:'Repairable plate panels.',value:180},
 {name:'Route Cloak',cls:'Rogue',rarity:'Common',defense:1,effect:'Weather protection.',value:130},
 {name:'Lantern Coat',cls:'Wizard',rarity:'Uncommon',defense:1,effect:'Insulated service lining.',value:190},
 {name:'Medic Rig',cls:'Healer',rarity:'Uncommon',defense:1,effect:'Accessible medical pouches.',value:190},
 {name:'Dredger Coat',cls:'Merchant',rarity:'Uncommon',defense:2,effect:'Delta weather protection.',value:240},
 {name:'Kilnrunner Jacket',cls:'Bard',rarity:'Uncommon',defense:1,effect:'Heat-resistant lining.',value:180},
];
