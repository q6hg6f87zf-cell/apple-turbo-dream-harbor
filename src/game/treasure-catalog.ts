...
export const TREASURE_CATALOG: CatalogItem[] = [
  ...
  { name: "Aether Rail", kind: "weapon", rarity: "Mythic", damage: "3d8", effect: "Critical hits ignore armor and strike a second target for half damage.", lore: "The projectile leaves before the trigger finishes moving.", value: 18800, sourceRegion: "veyra", classHint: "Wizard" },
