...
const FRAMES: Frame[] = [
  ...
  { stem: "M70 Springfield", family: "rifle", ammoType: ".30-06", rangeBand: "long", damage: "1d10+1", ap: 1, accuracy: 1, recoil: 2, magSize: 5, classHint: "Warrior", effect: "M70 bolt. Classic .30-06. Beasts and plate both notice.", value: 1480, rarity: "Uncommon" },
  ...
  { stem: "Rail Cannon", family: "heavy", ammoType: "rail", rangeBand: "long", damage: "2d8", ap: 3, accuracy: 0, recoil: 3, magSize: 4, classHint: "Warrior", effect: "AP 3. Restricted. The Warden notices this.", value: 4200, rarity: "Legendary", unlockRegion: "veyra", regions: ["veyra"] },
...
function gunFrom(frame: Frame, region: RegionId): ArsenalEntry {
  ...
  return {
    ...
    damage: frame.damage,
    effect: frame.effect,
    lore: `${brand.lore} ${frame.stem} pattern. Chambered ${frame.ammoType}. Built by ${brand.smith}.`,
...
const UNIQUES: ArsenalEntry[] = [
  {
    ...
    lore: "Ashen Pack field gun. Muzzle teeth, six rounds, built for animals, ambushes, and a road that does not forgive a jam.",
    value: 5400,
  ...
  },
  {
    ...
    lore: "Brasswater archive probe, still wet. Not a weapon the delta sells. The Sink is the archive, not a loot chest.",
    value: 5800,
  ...
  },
  {
    ...
    lore: "Heat-shielded five-round scattergun for furnace floors. Corrosion and coke, not a name someone gave a ghost.",
    value: 2400,
    sourceRegion: "slagtown",
    classHint: "Warrior",
    weaponFamily: "shotgun",
  ...
  },
  {
    ...
    lore: "Brasswater fabrication. Reusable bolts. A boat and salvage tool that can pull a light target. Retrieve what you fire.",
    value: 2700,
    sourceRegion: "brasswater",
    classHint: "Warrior",
    weaponFamily: "heavy",
  ...
  },
  {
    ...
    rarity: "Legendary",
    damage: "2d8",
    effect: "Manual .45-70 lever. Breaks armor and machine joints. Cannot be locked, updated, or told it lacks permission.",
    lore: "Travis keeps brass loops on the stock and hand-loads every serious round. Somebody always asks who paid for the repair. This is the last receipt.",
    value: 6400,
    sourceRegion: "ironclad",
    classHint: "Warrior",
    weaponFamily: "rifle",
  ...
  },
  {
    ...
    rarity: "Uncommon",
    damage: "1d8",
    effect: "Six shots. No electronics. Tolerates bad weather and worse stories.",
    lore: "Ironbound sidearm. Prewar frames, locally machined cylinders, .357. The Gate crews reload it themselves.",
    value: 480,
    sourceRegion: "ironclad",
    classHint: "Warrior",
    weaponFamily: "pistol",
  ...
  },
  {
    ...
    rarity: "Legendary",
    damage: "2d10",
    effect: "Loud .50. Devastating on AEGIS joints and vehicles. Too bulky for a casual walk.",
    lore: "Gravenor's convoy rifle. If you take it honorably, the Ashen routes come with it. Looting the man leaves you the gun and none of the scouts.",
    value: 8200,
    sourceRegion: "ironclad",
    classHint: "Warrior",
    weaponFamily: "sniper",
  ...
  },
  {
    ...
    rarity: "Legendary",
    damage: "2d8",
    effect: "Thermal maul. Cracks plate and can speak to Furnace Court gates. Who holds it after Slag Town holds the heat.",
    lore: "Valdris's two-hand industrial hammer. Combat is the smaller half. The furnaces answer the head.",
    value: 7600,
    sourceRegion: "slagtown",
    classHint: "Warrior",
    weaponFamily: "melee",
  ...
  },
  {
    ...
    rarity: "Legendary",
    damage: "1d10+2",
    effect: "Survey rifle. Maps dense material, then fires a focused charge at the lie in the structure.",
    lore: "Thessaly Vane's instrument. With her, it shows where Vesper rewrote the mountain. Without her, it is a fine tool and an incomplete map.",
    value: 7800,
    sourceRegion: "blackspire",
    classHint: "Rogue",
    weaponFamily: "sniper",
  ...
  },
  {
    ...
    rarity: "Legendary",
    damage: "2d8",
    effect: "8.6 coil-assisted. A human rifle with magnetic help. Anti-machine at medium range.",
    lore: "Marshal Iona Vale's command rifle. The projectile is still a bullet. The coils only mean Veyra stopped pretending recoil was the whole argument.",
    value: 8400,
    sourceRegion: "veyra",
    classHint: "Warrior",
    weaponFamily: "rifle",
  ...
  },
  {
    ...
    rarity: "Rare",
    damage: "1d8",
    effect: "10mm executive sidearm. The pistol is not the dangerous thing she carries.",
    lore: "Kane's personal gun. Clean, scarce, and smaller than the Black Key on the same belt.",
    value: 2100,
    sourceRegion: "veyra",
    classHint: "Rogue",
    weaponFamily: "pistol",
...
const AMMO_FRAMES: { ammoType: AmmoType; name: string; count: number; effect: string; value: number; rarity: Rarity; ap?: number; unlockDay?: number; unlockRegion?: RegionId; regions?: RegionId[] }[] = [
  ...
  { ammoType: ".30-06", name: ".30-06 Match Box", count: 8, effect: "8 match .30-06. +2 accuracy when spent from this box.", value: 440, rarity: "Rare" },
...
export const CALIBER_ROSTER: {
  ...
  { model: "M70 Springfield", ammo: ".30-06", family: "rifle", note: "Classic bolt. Beasts and plate notice." },
