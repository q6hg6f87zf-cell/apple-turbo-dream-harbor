...
export const TRIVIA: TriviaCard[] = [
  ...
  },
  {
    ...
    cat: "tyrone",
    tier: 2,
    q: "T-0880 and T-0888 share a wallet. What do they not share?",
    pick: "The chassis",
    decoys: ["The hangar", "The wallet", "The serial"],
    lore: "T-0880 is the robot in the vault. T-0888 is the Discord porch. Same manners. Two glasses.",
  },
  {
    id: "t-ty-word",
    cat: "tyrone",
...
export const TRUEFALSE: TfCard[] = [
  {
    ...
    answer: true,
    lore: "True. Vault 13 is T-0880. The Discord porch is T-0888. Same manners. Two glasses.",
  },
  {
    id: "tf-888",
    cat: "tyrone",
    tier: 1,
    q: "TyroneBot on Discord is T-0888.",
    answer: true,
    lore: "True. Porch programs, scored games, one wallet with this vault.",
  },
  {
    id: "tf-veyra-last",
    cat: "veyra",
