import type { ClassName, ItemKind, Rarity, RegionId } from "./types";
...
export const HOLLOW_CATALOG: CatalogItem[] = [
  // IRONCLAD · practical, heavy, repairable.
  { name: "Vault 13 Work Knife", kind: "weapon", rarity: "Common", damage: "1d4", effect: "+1 on salvage checks involving cable, cloth or seals.", lore: "Issued from a drawer that has been labelled TEMPORARY since before anyone remembers.", value: 85, sourceRegion: "ironclad", classHint: "Rogue" },
  ...
  { name: "Railspike Carbine", kind: "weapon", rarity: "Rare", damage: "1d10+1", effect: "On a strong hit, pin light targets in place for one round.", lore: "A maintenance launcher taught several bad habits.", value: 2100, sourceRegion: "ironclad", classHint: "Rogue" },

  // SLAG TOWN · heat, chemicals, brutal improvised industry.
  { name: "Slagglass Shiv", kind: "weapon", rarity: "Common", damage: "1d6", effect: "Bleed 1 on a strong hit. Breaks to Damaged on a fumble.", lore: "Bottle-green glass pulled from a furnace drain and wrapped in conveyor belt.", value: 130, sourceRegion: "slagtown", classHint: "Rogue" },
  ...
  { name: "Smelter's Eye", kind: "trinket", rarity: "Rare", effect: "+2 when judging metal quality, heat or structural weakness.", lore: "A smoked monocle etched with temperature marks nobody uses anymore.", value: 1200, sourceRegion: "slagtown", classHint: "Broker" as ClassName },
  ...
  { name: "Molten Chain", kind: "weapon", rarity: "Rare", damage: "2d6", effect: "20% chance to disarm on a strong hit.", lore: "A hoist chain with every third link sharpened and every good idea removed.", value: 2300, sourceRegion: "slagtown", classHint: "Warrior" },

  // BLACKSPIRE · cold, vertical, occult machinery.
  { name: "Spire Needle", kind: "weapon", rarity: "Uncommon", damage: "1d6+1", effect: "+1 against unaware or elevated targets.", lore: "Long, black and balanced for the kind of stairwell argument Blackspire is famous for.", value: 520, sourceRegion: "blackspire", classHint: "Rogue" },
  ...
  { name: "Echo Lantern", kind: "trinket", rarity: "Rare", effect: "Reveals hidden movement within short range when stationary.", lore: "It does not cast light. It shows what interrupted the dark.", value: 1500, sourceRegion: "blackspire", classHint: "Riftwright" as ClassName },
  ...
  { name: "Obsidian Coilgun", kind: "weapon", rarity: "Legendary", damage: "2d8", effect: "Ignores 1 DEF. Fumble: weapon becomes Worn.", lore: "Black ceramic rails wrapped around a humming copper spine.", value: 5200, sourceRegion: "blackspire", classHint: "Rogue" },

  // BRASSWATER · flooded machinery, pressure systems, salvage diving.
  { name: "Dockhook", kind: "weapon", rarity: "Common", damage: "1d6", effect: "+1 to pull, climb or grapple checks.", lore: "Half boat tool, half argument finisher.", value: 120, sourceRegion: "brasswater", classHint: "Warrior" },
  ...
  { name: "Coil-Harpoon", kind: "weapon", rarity: "Rare", damage: "1d10+2", effect: "Ranged. Strong hit drags small targets one step closer.", lore: "Built for things in the water. Nobody agrees what things.", value: 2500, sourceRegion: "brasswater", classHint: "Warrior" },

  // VEYRA CITY · clean lines, phase tech, expensive lies.
  { name: "Phase Baton", kind: "weapon", rarity: "Rare", damage: "1d8+1", effect: "On critical, bypass armor and stun for one action.", lore: "Veyra security calls it non-lethal. Veyra security has excellent lawyers.", value: 2600, sourceRegion: "veyra", classHint: "Warrior" },
  ...
  { name: "Veyran Aether Battery", kind: "material", rarity: "Legendary", effect: "Core component for high-tier Riftwright devices and Vault 13 upgrades.", lore: "Transparent casing, blue charge, absolutely no screws.", value: 4100, sourceRegion: "veyra" },
  ...
  { name: "Arc Lance", kind: "weapon", rarity: "Legendary", damage: "2d10", effect: "Chain 1 damage to a second nearby target on strong hit.", lore: "Military-grade current wrapped in museum-grade design.", value: 5900, sourceRegion: "veyra", classHint: "Wizard" },
];
