...
import { BookOpen, CircleHelp, Menu } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex items-start justify-between gap-2">
        <div className="ms-world-hud-plate min-w-0 max-w-[min(22rem,calc(100vw-7.75rem))] px-3 py-2">
          ...
          {hud.bulletin ? (
            <p
              ...
              className="mt-2 line-clamp-3 border-t border-line/40 pt-2 font-mono text-[10px] leading-relaxed text-moon"
            >
              {hud.bulletin}
            </p>
          ) : null}
